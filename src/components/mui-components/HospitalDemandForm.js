              ...
              <Grid container spacing={2}>
                <Grid item xs={12} sm={12} required>
                  ...
                  <MenuItem value="h10">H10</MenuItem> */}
                    <MenuItem value="Vijaya Hospital, Pogathota">
                      Vijaya Hospital, Pogathota
                    </MenuItem>
                    <MenuItem value="KIMS Hospital, Ambedkar Nagar">
                      KIMS Hospital, Ambedkar Nagar
                    </MenuItem>
                    <MenuItem value="Apollo Hospitals, Ramji Nagar">
                      Apollo Hospitals, Ramji Nagar
                    </MenuItem>
                    <MenuItem value="Narayana Hospital, Chinthareddy Palem">
                      Narayana Hospital, Chinthareddy Palem
                    </MenuItem>
                    <MenuItem value="Vijaya Care Hospital, Rama Murthy Palem">
                      Vijaya Care Hospital, Rama Murthy Palem
                    </MenuItem>
                    <MenuItem value="Rainbow Super Speciality Hospital, Brindavan Colony">
                      Rainbow Super Speciality Hospital, Brindavan Colony
                    </MenuItem>
                    <MenuItem value="Simhapuri Hospital, Balaji Nagar">
                      Simhapuri Hospital, Balaji Nagar
                    </MenuItem>
                    <MenuItem value="Lotus Hospital, Pogathota">
                      Lotus Hospital, Pogathota
                    </MenuItem>
                    <MenuItem value="St. Joseph Hospital, Santhapet">
                      St. Joseph Hospital, Santhapet
                    </MenuItem>
                    <MenuItem value="Jayabharath Hospital, Somasekhara Puram">
                      Jayabharath Hospital, Somasekhara Puram
                    </MenuItem>
                  </Select>
                </Grid>
